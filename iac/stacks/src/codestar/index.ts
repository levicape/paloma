...
export = async () => {
	...
	return all([
		...
		const exported = {
			paloma_codestar_ecr: ecr,
			paloma_codestar_codedeploy: codedeploy,
			paloma_codestar_appconfig: appconfig,
			paloma_codestar_codeartifact: codeartifact,
			paloma_codestar_ssm: ssm,
