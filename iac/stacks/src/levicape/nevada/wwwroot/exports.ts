...
export const PalomaNevadaWWWRootSubdomain = "nevada" as const;
 ...
 */
export const PalomaNevadaWWWRootExportsZod = z
	.object({
		paloma_nevada_wwwroot_cloudfront: z
			.object({
			...
			.nullish(),
		paloma_nevada_wwwroot_codebuild: z.object({
			invalidate: z.object({
				buildspec: z.object({
					bucket: z.string(),
					key: z.string(),
		...
		paloma_nevada_wwwroot_s3: z.object({
			artifacts: z.object({
				bucket: z.string(),
				region: z.string(),
			}),
